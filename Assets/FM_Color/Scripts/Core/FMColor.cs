...
public class FMColor : MonoBehaviour
{
    ...
    void FMCOLOR_Blit()
    {
        ...
        {
            RenderTexture MainTex = RenderTexture.GetTemporary(rt.width, rt.height, rt.depth, rt.format);
    ...
    string TargetShaderName = "Hidden/FMColor";
    ...
    public void Action_ToggleFXAA(bool _value)
    {
        FXAASettings.Enable = _value;
    }
